...
class TestLibrary():
    def test_library_length(self):
        ...
        assert isinstance(get_type_by_name(env, "length").data.data[0].data, StringType)
        assert isinstance(get_type_by_name(env, "length").data.data[1].data, IntegerType)
    ...
    def test_library_append(self):        
        ...
        assert isinstance(get_type_by_name(env, "append").data.data[0].data, CartType)
        assert isinstance(get_type_by_name(env, "append").data.data[0].data.data[0].data, StringType)
        assert isinstance(get_type_by_name(env, "append").data.data[0].data.data[1].data, StringType)
        assert isinstance(get_type_by_name(env, "append").data.data[1].data, StringType)
        arbitrary_init_machine(root, env, mch) # init VARIABLES and eval INVARIANT
        assert isinstance(root.children[4], AAssertionsMachineClause)
        interpret(root.children[4], env)
    ...
    def test_library_split(self):
        ...
        assert isinstance(get_type_by_name(env, "split").data.data[0].data, CartType)
        assert isinstance(get_type_by_name(env, "split").data.data[0].data.data[0].data, StringType)
        assert isinstance(get_type_by_name(env, "split").data.data[0].data.data[1].data, StringType)
        assert isinstance(get_type_by_name(env, "split").data.data[1].data.data, CartType)  
        assert isinstance(get_type_by_name(env, "split").data.data[1].data.data.data[0].data, IntegerType)
        assert isinstance(get_type_by_name(env, "split").data.data[1].data.data.data[1].data, StringType)      
        arbitrary_init_machine(root, env, mch) # init VARIABLES and eval INVARIANT 
        assert isinstance(root.children[4], AAssertionsMachineClause)
        interpret(root.children[4], env)
    ...
    def test_library_chars(self):
        ...
        assert isinstance(get_type_by_name(env, "chars").data.data[0].data, StringType)
        assert isinstance(get_type_by_name(env, "chars").data.data[1].data.data, CartType)  
        assert isinstance(get_type_by_name(env, "chars").data.data[1].data.data.data[0].data, IntegerType)
        assert isinstance(get_type_by_name(env, "chars").data.data[1].data.data.data[1].data, StringType) 
        arbitrary_init_machine(root, env, mch) # init VARIABLES and eval INVARIANT
        assert isinstance(root.children[4], AAssertionsMachineClause)
        interpret(root.children[4], env)
    ...
    def test_library_codes(self):
        ...
        assert isinstance(get_type_by_name(env, "codes").data.data[0].data, StringType)
        assert isinstance(get_type_by_name(env, "codes").data.data[1].data.data, CartType)  
        assert isinstance(get_type_by_name(env, "codes").data.data[1].data.data.data[0].data, IntegerType)
        assert isinstance(get_type_by_name(env, "codes").data.data[1].data.data.data[1].data, IntegerType) 
        arbitrary_init_machine(root, env, mch) # init VARIABLES and eval INVARIANT
        assert isinstance(root.children[4], AAssertionsMachineClause)
        interpret(root.children[4], env)
