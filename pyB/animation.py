...
# every solution generated by calc_possible_solutions musst be tested by the interpreter before the
# new state can be added to the result list
#
# generator-methods work by side-effects which change the top-of-stack state (current state)
# of the state-space. Tu assure independent state calculation of 
# 1. operations
...
def calc_next_states(env, bmachine):
    ...
    if bmachine.aOperationsMachineClause:
        ...
        for op in operations:
            ...
            # check node-lists
            # TODO: move this check into the parsing-phase
            ...
            if op_has_no_parameters:
                ...
                for possible in ex_sub_generator:
                    if possible:
                        ...
                        env.pop_frame()
                        bstate = env.state_space.get_state()  ## XXX remove?         
